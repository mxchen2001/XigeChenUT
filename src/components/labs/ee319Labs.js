...
const myData = [
    createData('Lab 1', 'Odd bit counter', 'Arm Assembly', '1-2hrs', null),
    createData('Lab 2', 'Temperature sensor data analysis', 'C', '1-2hrs', null),
    createData('Lab 3', 'LED and switch interface, circuit measurements, schematics', 'Arm Assembly', '1-2hrs', null),
    createData('Lab 4', 'Stepper motor software using Systick and FSM', 'Arm Assembly', '2-3hrs', null),
    createData('Lab 5', 'Cancelled due to COVID-19 (part of next lab)', 'N/A', 'N/A', null),
    createData('Lab 6', 'Digital Piano using a 4-bit DAC', 'C', '3-4hrs', null),
    createData('Lab 7', 'LCD device driver, decimal fixed-point output', 'Arm Assembly', '3-4hrs', null),
    createData('Lab 8', 'Real-Time Position Measurement System', 'C++', '2-3hrs', null),
    createData('Lab 9', 'Distributed Data Acquisition System', 'C', '2-3hrs', null),
    createData('Lab 10', 'Chrome Dinosaur Game built on TMC4', 'C, C++, Arm Assembly', '12-14hr', null),
];
